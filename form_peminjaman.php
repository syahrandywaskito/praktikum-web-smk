  ...
  <body>
    ...
    <!-- Table Input -->
  	<section class="container-input">
  		<div class="container">
  			<h1 class="fs-3">FORM INPUT DATA PEMINJAMAN SISWA</h1>
				<form method="post" action="proses_input_pinjam.php">
					<div class="mb-3">
          ...
          <select name="kode_buku" class="form-control">
            ...
            <?php
              ...
              foreach ($kode_buku as $row) {
                 echo "<option value=" . $row['kode_buku'] . ">" . $row['kode_buku'] . " - " . $row['judul_buku'] . "</option>";
               } 
             ?>
            <option>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~</option>
          </select>
