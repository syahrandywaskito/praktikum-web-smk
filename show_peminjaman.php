...
<html lang="en">
  ...
  <body>
    ...
    <section class="table-container">
      <div class="container">
        <h1 class="fs-3">DATA PEMINJAM BUKU PERPUSTAKAAN SEKOLAH</h1>
        <br>
        <a href="form_peminjaman.php" class="add-link">+ Tambah Data Baru</a>
        ...
        <table class="table table-bordered table-striped">
          ...
          if (isset($_POST['cari'])) {
             $opsi = $_POST['pilih'];
             $nama = $_POST['tekscari'];
             $input_pinjam = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE $opsi LIKE '%$nama%'");
           } 
          else{
             $input_pinjam = mysqli_query($koneksi, "SELECT * FROM peminjaman");
           }
           ?>
           <!--  -->
          ...
          foreach ($input_pinjam as $row) {
            echo "<tr>
                ...
                <td><a href='update_pinjam.php?kode_pinjam=$row[kode_pinjam]' class='btn btn-success btn-md'>Ubah</a>   
                  <a href='proses_hapus_pinjam.php?kode_pinjam=$row[kode_pinjam]' class='btn btn-success btn-md'>Hapus</a>
                </td>
                </tr>";
              $no++;
           } 
