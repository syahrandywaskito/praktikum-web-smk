  ...
  <body>
	...
	<section class="form-container">
		<div class="container center">
			...
			include 'koneksi.php';
			$kode = $_GET['kode_buku'];
			$query = mysqli_query($koneksi, "SELECT * FROM buku WHERE kode_buku = '$kode'");
			$row = mysqli_fetch_array($query); 
			 ?>
			<form method="post" action="proses_update.php">
        <div class="mb-3">
          <label class="form-label">Kode Buku</label>
          <input type="text" class="form-control" readonly value="<?php echo $row['kode_buku']; ?>" name="kode_buku">
        </div>
        <div class="mb-3">
